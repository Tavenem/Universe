...
namespace NeverFoundry.WorldFoundry.Planet.Climate
{
    ...
    public class Atmosphere : ISerializable
    {
        ...
        internal Atmosphere(Planet planet, double pressure, params (ISubstanceReference substance, decimal proportion)[] constituents) : this(pressure)
        {
        ...
        internal static Number GetAtmosphericMass(Planet planet, double pressure)
        ...
        /// Calculates the atmospheric density for the given conditions, in kg/m³.
        /// </summary>
        /// <param name="planet">The <see cref="Planet"/> on which the calculation is being
        /// made.</param>
        /// <param name="temperature">A temperature, in K.</param>
        ...
        /// </param>
        /// <returns>The atmospheric density for the given conditions, in kg/m³.</returns>
        public double GetAtmosphericDensity(Planet planet, double temperature, double elevation)
        ...
        /// </remarks>
        public double GetAtmosphericDrag(Planet planet, double temperature, double altitude, double speed) =>
        ...
        /// </remarks>
        public double GetAtmosphericPressure(Planet planet, double temperature, double elevation)
            => elevation <= 0
            ? AtmosphericPressure
        ...
        /// </summary>
        /// <param name="planet">The <see cref="Planet"/> which this atmosphere surrounds;
        ...
        public void SetAtmosphericPressure(Planet planet, double value)
        {
        ...
        internal void ResetPressureDependentProperties(Planet planet)
        {
            SetAtmosphericScaleHeight(planet);
        ...
        internal void ResetTemperatureDependentProperties(Planet planet)
        {
            SetAtmosphericScaleHeight(planet);
            SetAtmosphericHeight(planet);
            Material.Shape = GetShape(planet);
        ...
        /// </remarks>
        private void SetAtmosphericHeight(Planet planet, double? temp = null)
        {
        ...
        private void SetAtmosphericScaleHeight(Planet planet)
        ...
        /// <param name="planet">The <see cref="Planet"/> on which the calculation is being
        /// made.</param>
        private IShape GetShape(Planet planet) => new HollowSphere(planet.Shape.ContainingRadius, AtmosphericHeight);
