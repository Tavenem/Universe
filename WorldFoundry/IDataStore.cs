...
{
    /// <summary>
    /// An interface which allows <see cref="IIdItem"/> instances to be stored and retrieved.
    /// </summary>
    public interface IDataStore
    {
        ...
        /// type.</returns>
        IAsyncEnumerable<T> GetItemsAsync<T>() where T : class, IIdItem;
        ...
        /// <returns>An <see cref="IAsyncEnumerable{T}"/> of items in the data store of the given
        /// type.</returns>
        IAsyncEnumerable<T> GetItemsWhereAsync<T>(Func<T, bool> condition) where T : class, IIdItem;
        ...
        /// <returns>An <see cref="IAsyncEnumerable{T}"/> of items in the data store of the given
        /// type.</returns>
        IAsyncEnumerable<T> GetItemsWhereAwaitAsync<T>(Func<T, Task<bool>> condition) where T : class, IIdItem;
        ...
        Task SetItemAsync<T>(T item) where T : class, IIdItem;
    }
}
