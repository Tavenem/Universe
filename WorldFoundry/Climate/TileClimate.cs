...
{
    /// <summary>
    /// Indicates the climate of a <see cref="Grid.Tile"/> during a particular <see cref="Season"/>.
    /// </summary>
    public class TileClimate
    {
        ...
        /// <summary>
        /// The average atmospheric pressure in this <see cref="Grid.Tile"/> during this <see
        /// cref="Season"/>, in kPa.
        /// </summary>
        public float AtmosphericPressure { get; internal set; }

        /// <summary>
        /// The total precipitation in this <see cref="Grid.Tile"/> during this <see cref="Season"/>,
        ...
        /// <summary>
        /// The average thickness of sea ice in this <see cref="Grid.Tile"/> during this <see
        /// cref="Season"/>, in meters.
        /// </summary>
        public float SeaIce { get; internal set; }

        /// <summary>
        /// The total amount of snow which falls in this <see cref="Grid.Tile"/> during this <see
        ...
        /// <summary>
        /// The average temperature in this <see cref="Grid.Tile"/> during this <see cref="Season"/>,
        /// in K.
        /// </summary>
        public float Temperature { get; internal set; }

        /// <summary>
        /// The direction of the prevailing wind in this <see cref="Grid.Tile"/> during this <see
        /// cref="Season"/>, as an angle in radians from north.
        /// </summary>
        public float WindDirection { get; internal set; }

        /// <summary>
        /// The average speed of the prevailing wind in this <see cref="Grid.Tile"/> during this <see
        /// cref="Season"/>, in m/s.
        /// </summary>
