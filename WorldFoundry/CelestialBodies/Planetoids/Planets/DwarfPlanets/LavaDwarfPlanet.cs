...
namespace NeverFoundry.WorldFoundry.CelestialBodies.Planetoids.Planets.DwarfPlanets
{
    ...
    public class LavaDwarfPlanet : DwarfPlanet
    {
        ...
        internal LavaDwarfPlanet(string? parentId, Vector3 position) : base(parentId, position) { }
        ...
        /// </param>
        internal LavaDwarfPlanet(string? parentId, Vector3 position, Number maxMass) : base(parentId, position, maxMass) { }
