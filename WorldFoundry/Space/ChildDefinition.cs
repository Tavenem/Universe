...
namespace NeverFoundry.WorldFoundry.Space
{
    ...
    public class ChildDefinition
    {
        ...
        public ChildDefinition(Number space, Number density, CosmicStructureType structureType)
        {
            Density = density;
            Space = space;
        ...
        /// </returns>
        public virtual CosmicLocation? GetChild(CosmicLocation parent, Vector3 position, out List<CosmicLocation> children)
