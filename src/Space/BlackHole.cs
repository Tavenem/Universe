...
namespace Tavenem.Universe.Space
{
    ...
    {
        internal static readonly HugeNumber BlackHoleSpace = new(60000);
        internal static readonly HugeNumber SupermassiveBlackHoleThreshold = new(1, 33);
                ...
                else
                {
                    orbit = parent.StructureType switch
                    {
                        ...
                        CosmicStructureType.SpiralGalaxy
                            ...
                            or CosmicStructureType.DwarfGalaxy => Position.IsZero() ? null : parent.GetGalaxyChildOrbit(),
                        CosmicStructureType.GlobularCluster => Position.IsZero() ? null : parent.GetGlobularClusterChildOrbit(),
        ...
        internal static HugeNumber GetBlackHoleMassForSeed(uint seed, bool supermassive) => supermassive
            ? new Randomizer(seed).NextNumber(new HugeNumber(2, 35), new HugeNumber(2, 40)) // ~10e5–10e10 solar masses
            : new Randomizer(seed).NextNumber(new HugeNumber(6, 30), new HugeNumber(4, 31)); // ~3–20 solar masses
