...
namespace Tavenem.Universe.Space
{
    ...
    public class StarSystemChildDefinition : ChildDefinition
    {
        ...
        /// region.</param>
        public StarSystemChildDefinition(HugeNumber density) : base(StarSystem.StarSystemSpace, density) { }
        ...
        public StarSystemChildDefinition(
            ...
            bool allowBinary = true) : base(StarSystem.StarSystemSpace, HugeNumber.Zero)
        {
        ...
        private StarSystemChildDefinition(bool sunlike) : base(StarSystem.StarSystemSpace, HugeNumber.Zero)
        {
            Sunlike = sunlike;
            StarType = StarType.MainSequence;
