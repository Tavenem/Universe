...
public class StarSystemChildDefinition : ChildDefinition
{
    ...
    private StarSystemChildDefinition(bool sunlike) : base(StarSystem._StarSystemSpace, HugeNumber.Zero)
    {
        Sunlike = sunlike;
        StarType = StarType.MainSequence;
    ...
    /// cref="StarSystemChildDefinition"/>.
    /// </returns>
    public StarSystem? GetStarSystem(CosmicLocation? parent, Vector3<HugeNumber> position, out List<CosmicLocation> children) => new(
        parent,
        position,
        out children,
        orbit: null,
