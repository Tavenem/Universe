...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        /// </returns>
        public static Vector3? GetNearestOpenSpace(Vector3 position, HugeNumber radius, List<Location> children)
        {
            var insanityCheck = 0;
            Vector3? pos;
        ...
        public HugeNumber GetDistanceFromPositionTo(Vector3 position, Location other)
        ...
        /// cref="HugeNumber.PositiveInfinity"/>, if they do not
        /// share a common parent.</returns>
        public HugeNumber GetDistanceFromPositionTo(Vector3 localPosition, Location other, Vector3 otherPosition)
        ...
        /// no such open position could be found.
        /// </returns>
        public Vector3? GetOpenSpace(HugeNumber radius, List<Location> children)
        {
            var insanityCheck = 0;
            Vector3? pos;
            do
