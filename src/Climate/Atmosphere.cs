...
namespace Tavenem.Universe.Climate
{
    ...
    public class Atmosphere : ISerializable
    {
        ...
        internal double Hv2RsE
            => _hv2RsE ??= DoubleConstants.DeltaHvapWaterSquared * WaterRatioDouble * DoubleConstants.RSpecificRatioOfDryAirToWater;
        ...
        internal static HugeNumber GetAtmosphericMass(Planetoid planet, double pressure)
            => HugeNumber.FourPI * planet.RadiusSquared * pressure * 1000 / planet.SurfaceGravity;
